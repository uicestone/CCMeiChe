...
var _35 = "attributes@^1.4.1";
var _36 = "underscore@^1.6.0";
...
define(_17, [_29,_8,_27,_4], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
button.on("click",function(e){
  ...
  if(button.hasClass("arrive")){
    ...
    entries:entries,
    map:mix({"./mod/popmessage":_8,"./views/finishorder":_27,"./mod/countdown":_4},globalMap)
});
...
define(_27, [_29,_30,_31,_32,_33,_22,_12,_7,_8], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
module.exports = new FinishOrder();
    ...
    entries:entries,
    map:mix({"../tpl/finishorder.html":_22,"../mod/uploader":_12,"../mod/multiselect":_7,"../mod/popmessage":_8},globalMap)
});

define(_4, [_29], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
define(_13, [_29,_31,_30,_35,_36], function(require, exports, module, __filename, __dirname) {
var $ = require('zepto');
var util = require('util');
var events = require('events');
