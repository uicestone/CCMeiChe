...
var _10 = "zepto@^1.1.3";
var _11 = "tpl@~0.2.1";
var _12 = "hashstate@~0.1.0";
var _13 = "ccmeiche@0.1.0/pages/mod/autocomplete.js";
var _14 = "ccmeiche@0.1.0/pages/mod/singleselect.js";
var _15 = "ccmeiche@0.1.0/pages/mod/popselect.js";
var _16 = "ccmeiche@0.1.0/pages/mod/popmessage.js";
var _17 = "ccmeiche@0.1.0/pages/views/addcar.js";
var _18 = "ccmeiche@0.1.0/pages/views/preorder.js";
var _19 = "ccmeiche@0.1.0/pages/mod/input-clear.js";
var _20 = "util@^1.0.4";
var _21 = "events@^1.0.5";
var _22 = "ccmeiche@0.1.0/pages/mod/multiselect.js";
var _23 = "ccmeiche@0.1.0/pages/mod/uploader.js";
var _24 = "ccmeiche@0.1.0/pages/mod/swipe-modal.js";
var _25 = "ccmeiche@0.1.0/pages/tpl/addcar.html.js";
var _26 = "view-swipe@~0.1.4";
var _27 = "ccmeiche@0.1.0/pages/tpl/preorder.html.js";
var _28 = "uploader-mobile@~0.1.5";
var _29 = "ccmeiche@0.1.0/pages/mod/wechat-uploader.js";
var _30 = "attributes@^1.4.1";
var _31 = "underscore@^1.6.0";
var entries = [_0,_1,_2,_3,_4,_5,_6,_7,_8,_9];
var asyncDepsToMix = {};
var globalMap = asyncDepsToMix;
define(_3, [_10,_11,_12,_13,_14,_15,_16,_17,_18,_19], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
var tpl = require("tpl");
...
$("#go-wash").on("tap", function (e) {
  ...
  var order = {
    ...
    cars: $(".cars li").get().map(function (e, i) {
      return JSON.parse($(e).attr("data"))
    })
  };
...
if (!user.cars.length) {
  ...
  $("body").css("position", "static");
    ...
    entries:entries,
    map:mix({"./mod/autocomplete":_13,"./mod/singleselect":_14,"./mod/popselect":_15,"./mod/popmessage":_16,"./views/addcar":_17,"./views/preorder":_18,"./mod/input-clear":_19},globalMap)
});

define(_13, [_10,_20,_21], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
define(_14, [_10,_21,_20], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
var events = require("events");
var util = require("util");
...
define(_15, [_10,_21,_20,_14,_22], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
module.exports = function(choices,options){
  return new PopSelect(choices,options);
    ...
    entries:entries,
    map:mix({"./singleselect":_14,"./multiselect":_22},globalMap)
});

define(_16, [_10], function(require, exports, module, __filename, __dirname) {
var $ = require('zepto');
...
define(_17, [_10,_23,_13,_16,_24,_19,_25], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
module.exports = swipeModal.create({
  ...
  submit: function(data,callback){
    ...
    entries:entries,
    map:mix({"../mod/uploader":_23,"../mod/autocomplete":_13,"../mod/popmessage":_16,"../mod/swipe-modal":_24,"../mod/input-clear":_19,"../tpl/addcar.html":_25},globalMap)
});

define(_18, [_10,_26,_24,_16,_27], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
function formatTime(estimated_finish_time){
  ...
  return hours + addZero(minutes) + "分钟" + addZero(seconds) + "秒";
    ...
    entries:entries,
    map:mix({"../mod/swipe-modal":_24,"../mod/popmessage":_16,"../tpl/preorder.html":_27},globalMap)
});

define(_19, [_10], function(require, exports, module, __filename, __dirname) {
$ = require('zepto');
...
define(_22, [_10], function(require, exports, module, __filename, __dirname) {
var $ = require("zepto");
...
define(_23, [_10,_28,_16,_29], function(require, exports, module, __filename, __dirname) {
var $ = require('zepto');
...
exports.init = function(selector,options){
  ...
  return uploader;
    ...
    entries:entries,
    map:mix({"./popmessage":_16,"./wechat-uploader":_29},globalMap)
});

define(_24, [_20,_21,_26,_11,_12,_10], function(require, exports, module, __filename, __dirname) {
var util = require("util");
var events = require("events");
var viewSwipe = require("view-swipe");
var tpl = require("tpl");
...
define(_29, [_10,_20,_21,_30,_31], function(require, exports, module, __filename, __dirname) {
var $ = require('zepto');
var util = require('util');
var events = require('events');
