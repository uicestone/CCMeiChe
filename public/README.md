...
static files for ccmeiche

## Install

```bash
$ cortex install ccmeiche-static --save
```
...
```js
var ccmeiche_static = require('ccmeiche-static');
```
...
Creates a new ccmeiche-static instance.
...
### ccmeiche-static.&lt;method-name&gt;(arguments)
